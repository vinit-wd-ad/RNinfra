...
<body class="font-sans bg-rbg text-rtxt leading-[1.75]">
  ...
  <div class="bg-navy grid grid-cols-2 md:grid-cols-4">
    ...
    <div class="px-8 py-[1.6rem] text-center border-r border-white/[.08] border-b md:border-b-0">
      <div class="font-sans text-[2.4rem] font-light text-white/80 leading-none mb-[.3rem]">998</div>
    ...
    <div class="px-8 py-[1.6rem] text-center">
      <div class="font-sans text-[2.4rem] font-light text-white/80 leading-none mb-[.3rem]">AQI 32</div>
    ...
    <div class="max-w-[1240px] mx-auto">
      ...
      <div class="fade-up grid grid-cols-3 border border-rbdr bg-rsrf mb-10">
        ...
        <div id="tab-b3" onclick="switchTab('b3')" role="tab" aria-selected="true" tabindex="0"
          ...
          <div class="font-sans text-[1.45rem] font-normal leading-[1.2] mb-[.3rem] text-white">998 Sq.Ft.</div>
          <div class="text-[.82rem] font-semibold text-gold">Super Premium · Open</div>
        </div>
        <!-- Block 2 -->
  ...
  <section class="footer-grid-bg relative bg-navy overflow-hidden py-28 px-16 max-md:py-18 max-md:px-[1.4rem]"
    id="vip-form">
    <div class="max-w-[1240px] mx-auto relative z-[2]" id="contact">
      <div class="grid grid-cols-1 md:grid-cols-2 gap-20 md:gap-20 items-start">
        ...
        <!-- Form col -->
        <div>
          <form class="flex flex-col gap-[1.1rem]" id="vipForm" action="mailer/contact-message.php" method="POST">
            <input type="hidden" name="sub" value="Harison Barog !">
            <input type="hidden" name="redirect_url" value="<?= BASE_URL . 'harison-barog' ?>">
            <div>
            ...
            <div>
              ...
              <select id="f-interest" name="interest" class="vip-select" required>
                ...
                <option value="Block 3 — 998 Sq.Ft. (Super Premium)">Block 3 — 998 Sq.Ft. (Super Premium)</option>
                <option value="Block 2 — 772 Sq.Ft. (Premium)">Block 2 — 772 Sq.Ft. (Premium)</option>
                <option value="Block 1 — Notify Me When Launched">Block 1 — Notify Me When Launched</option>
                <option value="Official Quotation &amp; Payment Plan">Official Quotation &amp; Payment Plan</option>
                <option value="Site Visit Request">Site Visit Request</option>
                <option value="Home Loan Assistance (SBI / HDFC)">Home Loan Assistance (SBI / HDFC)</option>
